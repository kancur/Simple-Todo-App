      ...
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        var ___CSS_LOADER_URL_IMPORT_0___ = new URL(
          /* asset import */ __webpack_require__(
            /*! ./assets/Lato-Regular.ttf */ "./src/assets/Lato-Regular.ttf"
          ),
...
*/
  ...
  \****************************/
      /***/ (
        ...
        /* harmony import */ var _ProjectList__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./ProjectList */ "./src/modules/ProjectList.js"
          );
        ...
        class App {
          constructor() {
            this.storage = new _Storage__WEBPACK_IMPORTED_MODULE_4__[
              "default"
            ]();
            ...
            this.projectList = new _ProjectList__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ]();
            this.currentProjectId = this.storage.loadCurrentID() || 0;
            this.isFirstRun =
              this.storage.loadStringified("isFirstRun") === null
                ? true
                : false;
            this.initialize();
          }
          ...
          populateProjectsFromLocalStorageData(data) {
            if (data) {
              data.forEach((project) => {
                const id = this.projectList.addProject(
          ...
          populateProjectWithTodos(project, todos) {
            todos.forEach((todo) => {
              if (todo.dueDate) {
                todo.dueDate = (0,
                date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dueDate);
              }
              const todoObject = Object.assign(
                new _Todo__WEBPACK_IMPORTED_MODULE_3__["default"](),
                todo
              );
          ...
          addTestProjects() {
            this.projectList.addProject(
              new _Project__WEBPACK_IMPORTED_MODULE_1__["default"]("School")
            );
            this.projectList.addProject(
              new _Project__WEBPACK_IMPORTED_MODULE_1__["default"]("Work")
            );
            this.projectList.addProject(
              new _Project__WEBPACK_IMPORTED_MODULE_1__["default"](
                "Future plans"
          ...
          handleProjectAdd = (name) => {
            const newProject = new _Project__WEBPACK_IMPORTED_MODULE_1__[
              "default"
            ](name);
          ...
          handleTodoAdd = (data) => {
            ...
            let date = undefined;
            if (data.date) {
              date = (0, date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(
                data.date
              );
            }
          ...
          rerenderTodosLogic() {
            const currentProject = this.projectList.getProject(
              this.currentProjectId
            );
      ...
      /***/ (
        ...
        class UI {
          ...
          addTodoModal(projectCreationHandler) {
            ...
            const todoTitleLabel = this.createLabel(
              "todo-title",
              "Enter todo title"
            );
            ...
            todoForm.addEventListener("submit", (e) => {
              ...
              if (todoTitle.value.trim().length > 2) {
                ...
                notification.innerText =
                  "A title of atleast 3 characters is required";
              }
            });
  ...
  \**********************/
    ...
    /* harmony import */ var _modules_App__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./modules/App */ "./src/modules/App.js");
